...
{
    [BurstCompile]
    public struct BallGhostComponentSerializer
    {
        static BallGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<Ball>(),
                ComponentSize = UnsafeUtility.SizeOf<Ball>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Ball>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Ball>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Ball>(backupData, 0);
